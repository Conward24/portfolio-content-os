...
export const PULSE_SLOTS = [
  ...
  { slot: 6, brand: 'henway', since: '2026-08-09', topic:
    'Enterprise AI adoption failure, stalled pilots, and return on investment scrutiny',
    why: 'The core wedge every carousel and one-pager opens on.' },
  { slot: 7, brand: 'henway', since: '2026-08-09', topic:
    'Consultancies and agencies productizing artificial intelligence services for clients',
    why: 'Channel beachhead, and the audience for the outbound sequence.' },
  { slot: 8, brand: 'henway', since: '2026-08-09', topic:
    'HR and learning and development mandates for artificial intelligence upskilling in the workforce',
    why: 'Second ICP, the design-partner pilot audience.' },
  { slot: 9, brand: 'blabbing', since: '2026-08-09', topic:
    'Public relations and corporate communications industry trends, including crisis response and reputation management',
    why: 'Crisis Radar buyer and the home well for The Early Signal.' },
  { slot: 10, brand: 'blabbing', since: '2026-08-09', topic:
    'Commercial real estate market sentiment, including office vacancy, valuations, and return-to-office policy',
    why: 'Proven vertical with real volume, so the engine has something to catch.' },
];
