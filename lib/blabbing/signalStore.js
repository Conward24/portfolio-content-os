 ...
 * re-ingest the same emails from scratch. Exists because signals are stored
 * parsed, not raw: when a parser bug is fixed there is nothing to re-derive
 * from, and the dedup set would otherwise reject the corrected re-run.
 *
