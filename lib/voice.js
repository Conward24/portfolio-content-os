...
1. **Open with the commenter's FULL name as an @-mention**, then continue in the same line
   ...
   **If the name is not visible in what you were given, just start the reply without a mention.**
   NEVER write a placeholder like [Name] or [Commenter Full Name] — these replies get pasted
   straight into LinkedIn, and a placeholder posted live is worse than no mention at all.
